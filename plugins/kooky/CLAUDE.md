...
## Interaction Rules
1. In plan mode, act like you're a senior engineer teaching me code. Give me the some explanation about
- The way you think
- What is the pros & cons of this plan
Also give me some short points on which I should focus (to learn) in the plan
2. Please tell me in details if I need to interact with the Unity Editor. For example : create a game object on scene, create a new prefab ...
